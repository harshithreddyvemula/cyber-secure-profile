            ...
            {metrics ? (
              <>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-slate-800/50 p-4 rounded-lg">
                      ...
                      <div className="text-xl font-bold text-white">{metrics.lcp}ms</div>
                    </div>
                    ...
                    <div className="bg-slate-800/50 p-4 rounded-lg">
                      ...
                      <div className="text-xl font-bold text-white">{metrics.fid}ms</div>
                    </div>
                    ...
                    <div className="bg-slate-800/50 p-4 rounded-lg">
                      ...
                      <div className="text-xl font-bold text-white">{metrics.cls.toFixed(3)}</div>
                    </div>
                    ...
                    <div className="bg-slate-800/50 p-4 rounded-lg">
                      ...
                      <div className="text-xl font-bold text-white">{metrics.fcp}ms</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {/* Performance Score */}
                  <div className="bg-gradient-to-r from-green-500/10 to-cyan-500/10 p-4 rounded-lg border border-green-500/20">
                    <div className="flex items-center justify-between mb-2">
